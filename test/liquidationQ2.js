...
describe("liquidationQ2", function () {

  // 2000 USDT Liquidation

  it("It is recommended to liquidate with 2000 USDT.", async function () {
    console.log(
      "\n------------------- 2000 USDT Liquidation in process -------------------"
    );
    ...
    console.log(
      `Profit from employing ${usdtValue} USDT is`,
  ...
  it("It is recommended to liquidate with 5000 USDT.", async function () {
    console.log(
      "\n------------------- 5000 USDT Liquidation in process -------------------"
    );
    await network.provider.request({
      method: "hardhat_reset",
      params: [
  ...
  it("It is not recommended to liquidate with 10000 USDT.(transaction reverted)", async function () {
    console.log(
      "\n------------------- 10000 USDT Liquidation in process -------------------"
    );
    await network.provider.request({
      method: "hardhat_reset",
      params: [
